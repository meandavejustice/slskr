...
~~~sh
# getting the code
git clone git@github.com:nko4/brew-rocket-fuel.git && cd ./brew-rocket-fuel/

# developing
npm install
npm start

# deploying (to http://brew-rocket-fuel.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@brew-rocket-fuel.2013.nodeknockout.com
ssh root@brew-rocket-fuel.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@brew-rocket-fuel.2013.nodeknockout.com
ssh -i ./id_deploy root@brew-rocket-fuel.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/brew-rocket-fuel" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
